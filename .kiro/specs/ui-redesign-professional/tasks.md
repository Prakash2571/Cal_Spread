...
- [ ] 1. Phase 1 — Token_Block and Alias_Block (additive)

  - [ ] 1.1 Add the Token_Block to `src/styles.css`
  ...
  - [ ] 1.2 Add the temporary Alias_Block to `src/styles.css`
...
- [ ] 2. Phase 2 — Base layer (body, typography, focus, motion, shell meta)

  - [ ] 2.1 Flatten the body and app shell in `src/styles.css`
  ...
  - [ ] 2.2 Install the typographic scale and the numeric rule in `src/styles.css`
  ...
  - [ ] 2.3 Add the global focus indicator to `src/styles.css`
  ...
  - [ ] 2.4 Add the reduced-motion block to `src/styles.css`
  ...
  - [ ] 2.5 Update the shell meta in `index.html`
...
- [ ] 3. Phase 3 — Shell (topbar, buttons, inputs, status, banners)

  - [ ] 3.1 De-blur the topbar and flatten the brand mark in `src/styles.css`
  ...
  - [ ] 3.2 Unify button geometry and the four variants in `src/styles.css`
  ...
  - [ ] 3.3 Unify the three input controls in `src/styles.css`
  ...
  - [ ] 3.4 Restyle status pill, counters, banners, links, and legend tags in `src/styles.css`
...
- [ ] 5. Phase 4 — Board (card, table, chips, skeletons, breakpoints)

  - [ ] 5.1 De-glass the stock card in `src/styles.css`
  ...
  - [ ] 5.2 Restyle the card table in `src/styles.css`
  ...
  - [ ] 5.3 Collapse chips and value colors onto one geometry in `src/styles.css`
  ...
  - [ ] 5.4 Rebuild the skeleton shimmer on opaque stops in `src/styles.css`
  ...
  - [ ] 5.5 Consolidate the four breakpoints and touch targets in `src/styles.css`
...
- [ ] 6. Phase 5 — Detail page and charts

  - [ ] 6.1 Flatten the detail surfaces in `src/styles.css`
  ...
  - [ ] 6.2 Rebuild `.chart-toggle` as a segmented control in `src/styles.css`
  ...
  - [ ] 6.3 Token-drive the SVG chart furniture and tooltip in `src/styles.css`
  ...
  - [ ] 6.4 Fold the two 2px dot radii onto `--r-sm` in `src/styles.css`
  ...
  - [ ] 6.5 Substitute the series color literals in `src/StockDetail.tsx`
...
- [ ] 8. Phase 6 — Overlays (modals, trades panel, admin)

  - [ ] 8.1 De-blur the scrim and restyle the modal shell in `src/styles.css`
  ...
  - [ ] 8.2 Add the modal width classes to `src/styles.css`
  ...
  - [ ] 8.3 Restyle the trades panel with nested elevation in `src/styles.css`
  ...
  - [ ] 8.4 Flatten the admin page in `src/styles.css`
  ...
  - [ ] 8.5 Apply the small modal width class in `src/TradeConfirmModal.tsx`
  ...
  - [ ] 8.6 Apply the medium modal width class in `src/AccessTokenModal.tsx`
    - **Permitted edits: (A) className change, and deletion of the static inline `maxWidth` declaration it replaces.**
  ...
  - [ ] 8.7 Unify the admin brand mark color in `src/Admin.tsx`
    - **Permitted edit: (D) color-literal substitution only.**
...
- [ ] 9. Phase 7 — Finalize (inline extraction, alias removal, sweep)

  - [ ] 9.1 Add the `.metric-*` classes to `src/styles.css`
  ...
  - [ ] 9.2 Add the `.confirm-*` classes to `src/styles.css`
  ...
  - [ ] 9.3 Add the `.token-*` classes to `src/styles.css`
  ...
  - [ ] 9.4 Extract the inline styles in `src/StockDetail.tsx`
  ...
  - [ ] 9.5 Extract the inline styles in `src/TradeConfirmModal.tsx`
    - **Permitted edits: (A) className change, (B) wrapper element carrying only styling, (D) color-literal substitution.**
  ...
  - [ ] 9.6 Extract the inline styles in `src/AccessTokenModal.tsx`
    - **Permitted edits: (A) className change, (B) wrapper element carrying only styling, (D) color-literal substitution.**
  ...
  - [ ] 9.8 Remove the Alias_Block and the legacy `:root` block from `src/styles.css`
  ...
  - [ ] 9.9 Vocabulary collapse sweep over `src/styles.css`
...
- [ ] 10. Static verification assertion suite (Requirement 12.3)

  - [ ] 10.1 Assert glass removal over `src/styles.css`
  ...
  - [ ] 10.2 Assert color-literal containment and token closure over `src/styles.css`
  ...
  - [ ] 10.3 Assert class-name coverage across `src/*.tsx` and `src/styles.css`
  ...
  - [ ] 10.4 Assert the bounded design vocabulary over `src/styles.css`
  ...
  - [ ] 10.5 Assert semantic-color separation and focus-rule presence over `src/styles.css`
  ...
  - [ ] 10.6 Assert scope containment across the diff
